...
func (p *kAuthServiceClient) Register(ctx context.Context, Req *auth.UserRegisterRequest, callOptions ...callopt.Option) (r *auth.UserRegisterResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.Register(ctx, Req)
}

func (p *kAuthServiceClient) Login(ctx context.Context, Req *auth.UserLoginRequest, callOptions ...callopt.Option) (r *auth.UserLoginResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
