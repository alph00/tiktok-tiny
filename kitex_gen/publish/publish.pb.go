...
// 	protoc        v3.11.4
// source: idl/publish/publish.proto
...
func (x *Video) Reset() {
	*x = Video{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_publish_publish_proto_msgTypes[0]
...
func (*Video) Descriptor() ([]byte, []int) {
	return file_idl_publish_publish_proto_rawDescGZIP(), []int{0}
}
...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_publish_publish_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_idl_publish_publish_proto_rawDescGZIP(), []int{1}
}
...
func (x *PublishActionRequest) Reset() {
	*x = PublishActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_publish_publish_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PublishActionRequest) Descriptor() ([]byte, []int) {
	return file_idl_publish_publish_proto_rawDescGZIP(), []int{2}
}
...
func (x *PublishActionResponse) Reset() {
	*x = PublishActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_publish_publish_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PublishActionResponse) Descriptor() ([]byte, []int) {
	return file_idl_publish_publish_proto_rawDescGZIP(), []int{3}
}
...
func (x *PublishListRequest) Reset() {
	*x = PublishListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_publish_publish_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PublishListRequest) Descriptor() ([]byte, []int) {
	return file_idl_publish_publish_proto_rawDescGZIP(), []int{4}
}
...
func (x *PublishListResponse) Reset() {
	*x = PublishListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_publish_publish_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PublishListResponse) Descriptor() ([]byte, []int) {
	return file_idl_publish_publish_proto_rawDescGZIP(), []int{5}
}
...
var File_idl_publish_publish_proto protoreflect.FileDescriptor

var file_idl_publish_publish_proto_rawDesc = []byte{
	0x0a, 0x19, 0x69, 0x64, 0x6c, 0x2f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x2f, 0x70, 0x75,
	0x62, 0x6c, 0x69, 0x73, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x70, 0x75, 0x62,
	0x6c, 0x69, 0x73, 0x68, 0x22, 0xf9, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x25,
	0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d,
	0x2e, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x06, 0x61,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x22, 0x56, 0x0a, 0x14, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x41,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0x57, 0x0a, 0x15,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x84, 0x01, 0x0a, 0x13, 0x50,
	...
	,
}

var (
	file_idl_publish_publish_proto_rawDescOnce sync.Once
	file_idl_publish_publish_proto_rawDescData = file_idl_publish_publish_proto_rawDesc
)

func file_idl_publish_publish_proto_rawDescGZIP() []byte {
	file_idl_publish_publish_proto_rawDescOnce.Do(func() {
		file_idl_publish_publish_proto_rawDescData = protoimpl.X.CompressGZIP(file_idl_publish_publish_proto_rawDescData)
	})
	return file_idl_publish_publish_proto_rawDescData
}

var file_idl_publish_publish_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_idl_publish_publish_proto_goTypes = []interface{}{
	(*Video)(nil),                 // 0: publish.Video
	(*User)(nil),                  // 1: publish.User
	(*PublishActionRequest)(nil),  // 2: publish.PublishActionRequest
	(*PublishActionResponse)(nil), // 3: publish.PublishActionResponse
	(*PublishListRequest)(nil),    // 4: publish.PublishListRequest
	(*PublishListResponse)(nil),   // 5: publish.PublishListResponse
}
var file_idl_publish_publish_proto_depIdxs = []int32{
	1, // 0: publish.Video.author:type_name -> publish.User
	0, // 1: publish.PublishListResponse.video_list:type_name -> publish.Video
	2, // 2: publish.PublishService.PublishAction:input_type -> publish.PublishActionRequest
	4, // 3: publish.PublishService.PublishList:input_type -> publish.PublishListRequest
	3, // 4: publish.PublishService.PublishAction:output_type -> publish.PublishActionResponse
	5, // 5: publish.PublishService.PublishList:output_type -> publish.PublishListResponse
...
func init() { file_idl_publish_publish_proto_init() }
func file_idl_publish_publish_proto_init() {
	if File_idl_publish_publish_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_idl_publish_publish_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Video); i {
			case 0:
				return &v.state
			case 1:
		...
		file_idl_publish_publish_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_idl_publish_publish_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_publish_publish_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_publish_publish_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_publish_publish_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_idl_publish_publish_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_idl_publish_publish_proto_goTypes,
		DependencyIndexes: file_idl_publish_publish_proto_depIdxs,
		MessageInfos:      file_idl_publish_publish_proto_msgTypes,
	}.Build()
	File_idl_publish_publish_proto = out.File
	file_idl_publish_publish_proto_rawDesc = nil
	file_idl_publish_publish_proto_goTypes = nil
	file_idl_publish_publish_proto_depIdxs = nil
}
