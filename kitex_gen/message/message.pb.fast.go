...
func (x *MessageActionRequest) fastReadField5(buf []byte, _type int8) (offset int, err error) {
	x.Id, offset, err = fastpb.ReadInt64(buf, _type)
	return offset, err
}
...
func (x *MessageActionRequest) fastWriteField5(buf []byte) (offset int) {
	if x.Id == 0 {
		return offset
	}
	offset += fastpb.WriteInt64(buf[offset:], 5, x.GetId())
	return offset
}
...
func (x *MessageActionRequest) sizeField5() (n int) {
	if x.Id == 0 {
		return n
	}
	n += fastpb.SizeInt64(5, x.GetId())
	return n
}
